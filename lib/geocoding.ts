...
> = {
  ...
  Isfahan: { lat: 32.6546, lng: 51.668, country: "Iran" },
  Esfahan: { lat: 32.6546, lng: 51.668, country: "Iran" },
  Shiraz: { lat: 29.5918, lng: 52.5837, country: "Iran" },
  Tabriz: { lat: 38.08, lng: 46.2919, country: "Iran" },
  Mashhad: { lat: 36.2972, lng: 59.6067, country: "Iran" },
  Qom: { lat: 34.6401, lng: 50.8764, country: "Iran" },
  Bushehr: { lat: 28.9234, lng: 50.8203, country: "Iran" },
  Natanz: { lat: 33.5131, lng: 51.9161, country: "Iran" },
  Fordow: { lat: 34.708, lng: 51.118, country: "Iran" },
  Arak: { lat: 34.0917, lng: 49.6892, country: "Iran" },
  ...
  Parchin: { lat: 35.5206, lng: 51.7781, country: "Iran" },
  Kharg: { lat: 29.2333, lng: 50.3167, country: "Iran" },
  "Strait of Hormuz": { lat: 26.5667, lng: 56.25, country: "Iran" },
  Hormuz: { lat: 26.5667, lng: 56.25, country: "Iran" },
  "Persian Gulf": { lat: 26.0, lng: 52.0, country: "Iran" },
